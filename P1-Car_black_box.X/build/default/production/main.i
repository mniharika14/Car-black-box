...
void main(void) {
    ...
    while (1) {
        ...
        if (flag1 == 1) {
            ...
            clcd_print(gear[count], (0xC0 + (10)));
            clcd_putch(adc / 10 + '0', (0xC0 + (14)));
            clcd_putch(adc % 10 + '0', (0xC0 + (15)));
        ...
        if (flag1 == 2) {
            ...
            if (flag3 == 1) {
                clcd_print("VIEW LOG", (0x80 + (1)));
                clcd_print("SET TIME", (0xC0 + (1)));
            }

            if (flag3 == 2) {
                clcd_print("SET TIME", (0x80 + (1)));
                clcd_print("DOWNLOAD LOG", (0xC0 + (1)));
            }
            if (flag3 == 3) {
                clcd_print("DOWNLOAD LOG", (0x80 + (1)));
                clcd_print("CLEAR LOG", (0xC0 + (1)));
            }
        }
        if (flag1 == 3) {
            ...
            if (flag3 == 1 && star == 1) {
                if (clear == 0) {
                    ...
                    store[10] = '\0';
                    clcd_putch(((storing_data/10) + '0'), (0xC0 + (0)));
                    clcd_putch(store[0], (0xC0 + (2)));
                    clcd_putch(store[1], (0xC0 + (3)));
                    clcd_putch(':', (0xC0 + (4)));
                    clcd_putch(store[2], (0xC0 + (5)));
                    clcd_putch(store[3], (0xC0 + (6)));
                    clcd_putch(':', (0xC0 + (7)));
                    clcd_putch(store[4], (0xC0 + (8)));
                    clcd_putch(store[5], (0xC0 + (9)));
                    clcd_putch(store[6], (0xC0 + (11)));
                    clcd_putch(store[7], (0xC0 + (12)));
                    clcd_putch(store[8], (0xC0 + (14)));
                    clcd_putch(store[9], (0xC0 + (15)));
                    clcd_putch(store[10], (0xC0 + (16)));
                }
            }
                ...
                for( int i=0;i<(data_lim/10);i++){
                    for(int j=0;j<17;j++){
                        if(j==1 || j==2 || j==11 || j==14){
                            ...
                            download[i][j]= read_external_eeprom(b++);
                        }
                    }
                    download[i][17] = '\0';
                }
            ...
            if (flag3 == 3 && star == 2){
                clear = 0;
                clcd_print("CLEARING LOGS", (0x80 + (1)));
                clcd_print("PLEASE WAIT...", (0xC0 + (1)));
                stop = 0;
                if(delay++ > 400){
                flag1 = 2;
                flag3 =1;
