...
unsigned char scan_key(void);//assigning values for the row, read value return the value
unsigned char read_switches(unsigned char detection_type);//detect edge triger
